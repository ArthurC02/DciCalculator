...
public class VolSurfaceTests
{
    ...
    public void InterpolatedVolSurface_ATMVol_Interpolates()
    {
        ...
        // Assert: 期限越長，波動度越高（Term Structure）
    ...
    public void InterpolatedVolSurface_IsInRange_ChecksBoundaries()
    {
        ...
        // Act & Assert
        Assert.True(surface.IsInRange(30.5, 0.50));   // 範圍內
        Assert.False(surface.IsInRange(28.0, 0.50));  // Strike 過低
        Assert.False(surface.IsInRange(30.5, 2.00));  // Tenor 過長
    }
